...
public class HomePage extends ActionBarActivity implements
	...
	public void email(View v) {
		startActivity(new Intent(Intent.ACTION_VIEW,Uri.parse("http://mail.mycit.ie/")));
	}
	...
	public void card(View v) {
		startActivity(new Intent(Intent.ACTION_VIEW,Uri.parse("https://citcard.cit.ie/icmserver/")));
	}
	...
	public void onSectionAttached(int number) {
		...
		case 6:
			...
			break;			
		case 7:
			Intent studentCalendar = new Intent(HomePage.this, StudentCalendar.class);
			startActivity(studentCalendar);
			break;
		case 8:
		...
		case 9:
			...
			break;
		case 10:
			Intent payFeesOnline = new Intent(HomePage.this, PayFeesOnline.class);
			startActivity(payFeesOnline);
			break;
		case 11:
		...
		case 14:
			...
			break;
		case 15:
			Intent publicFolders = new Intent(HomePage.this, PublicFolders.class);
			startActivity(publicFolders);
			break;
		}
	}
